import { e as editor, p as process, R as Range$1, l as languages, a as MarkerSeverity } from './editor.main-1bbb8e5c.js';
...
/** @class */ ((function () {
    ...
    JSONSchemaService.prototype.loadSchema = function (url) {
        ...
        return this.requestService(url).then(function (content) {
            if (!content) {
                var errorMessage = localize$1('json.schema.nocontent', 'Unable to load schema from \'{0}\': No content.', toDisplayString(url));
            ...
            return new UnresolvedSchema({}, [localize$1('json.schema.nocontent', 'Unable to load schema from \'{0}\': {1}.', toDisplayString(url), errorMessage)]);
        });
    };
...
export { setupMode };
//# sourceMappingURL=jsonMode-d693b999.js.map
